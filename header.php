                    ...
                    <div class="container">
                        <div class="row">
                            <div class="hom-nav d-flex justify-content-md-center justify-content-sm-start <?php if (!isset($_SESSION['user_name']) && empty($_SESSION['user_name'])) {
                                ...
                                <div class="menu">
                                    <div class="explore-cls"><?php echo $BIZBOOK['EXPLORE']; ?></div>
                                </div>
                                ...
                                <ul class="bl align-content-center ">
                                    ...
                                    <li>
                                        <a href="/login"
                                            class="text-decoration-none"><?php echo $BIZBOOK['SIGN_IN']; ?></a>
                                    </li>
                                    <li>
                                        <a href="/login?login=register"
                                            class="text-decoration-none"><?php echo $BIZBOOK['CREATE_AN_ACCOUNT']; ?></a>
                                    </li>
                                    <?php
                                    } else {
                                    ?>
