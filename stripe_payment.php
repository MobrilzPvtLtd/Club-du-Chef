                ...
                <div class="log ">
                    <div class="login">
                        ...
                        <div><?php echo $Zitiziti['HI']; ?> <?php echo $user_details_row['first_name']; ?>,</br> <?php echo $Zitiziti['DB-PAYMENTS-STRIPE-PAYMENT-YOUR-FINAL-AMOUNT']; ?> :
                            <b><?php if($footer_row['currency_symbol_pos']== 1){ echo $footer_row['currency_symbol']; } ?><?php echo $user_plan_type['plan_type_price']; ?><?php if($footer_row['currency_symbol_pos']== 2){ echo $footer_row['currency_symbol']; } ?></b>
                        </div>
                        <form name="payment_stripe_form" id="payment_stripe_form" method="post"
                            ...
                            <button type="submit" name="stripe_payment_submit" id="stripe_payment_submit"
                                ...
                                <?php echo $Zitiziti['PAY']; ?> <?php if($footer_row['currency_symbol_pos']== 1){ echo $footer_row['currency_symbol']; } ?><?php echo $user_plan_type['plan_type_price']; ?><?php if($footer_row['currency_symbol_pos']== 2){ echo $footer_row['currency_symbol']; } ?>
