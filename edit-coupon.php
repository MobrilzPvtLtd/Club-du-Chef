    ...
    <div class="container">
        <div class="row">
            <div class="login-main add-list">
                ...
                <span class="steps"><?php echo $Zitiziti['EDIT_THIS_COUPON']; ?></span>
                <div class="log">
                    <div class="login">
                        <h4><?php echo $Zitiziti['EDIT_THIS_COUPON']; ?></h4>
                        ...
                        <form name="coupon_form" id="edit_coupon_form" enctype="multipart/form-data" method="post"
                              action="coupon_update.php" class="listing_form_1">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo $Zitiziti['COUPON-BRAND-LOGO-PLACEHOLDER']; ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="<?php echo date ('m/d/Y', strtotime($coupon_row['coupon_start_date'])); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="<?php  echo date ('m/d/Y', strtotime($coupon_row['coupon_end_date'])); ?>"
                            ...
                            <button type="submit" name="coupon_submit" class="btn btn-primary"><?php echo $Zitiziti['SUBMIT']; ?></button>
                        </form>
                    </div>
                </div>
            </div>
