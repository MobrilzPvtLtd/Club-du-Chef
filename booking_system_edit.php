...
<div class="col-md-12" id="booking-details" style="display:<?php echo ($edit_a_row['is_booking'] == 1 || $edit_a_row['booking_url'] != '') ? 'block' : 'none'; ?>;">
    <div class="form-check">
        <input class="form-check-input" type="radio" value="1" name="is_booking" id="is_booking" <?php if (!isset($_SESSION['admin_id'])) echo 'style="height: 13px;"'; ?> <?php echo $edit_a_row['is_booking'] == 1 ? 'checked' : ''; ?>>
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" value="0" name="is_booking" id="is_booking_url" <?php if (!isset($_SESSION['admin_id'])) echo 'style="height: 13px;"'; ?> <?php echo $edit_a_row['is_booking'] == 0 ? 'checked' : ''; ?>>
