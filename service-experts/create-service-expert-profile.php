    ...
    <div class="container">
        <div class="row">
            <div class="login-main add-list">
                ...
                <span class="steps"><?php echo $Zitiziti['SERVICE-EXPERT-PROFILE-LABEL']; ?></span>
                <div class="log">
                    <form action="service_expert_insert.php" class="service_expert_form" id="service_expert_form"
                        ...
                        <div class="inn">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-START-TIME-LABEL']; ?></label>
                                ...
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-CLOSE-TIME-LABEL']; ?></label>
                                ...
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-PROFILE-IMAGE-LABEL']; ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-WORK-PROFESSION-LABEL']; ?></label>
                                ...
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-BASE-FARE-LABEL']; ?></label>
                                ...
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['JOB-INTERVIEW-PROFILE-COVER-IMAGE-LABEL']; ?></label>
                                    <div class="fil-img-uplo">
                                        <span class="dumfil"><?php echo $Zitiziti['UPLOAD_A_FILE'];  ?></span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-SERVICES-CAN-DO-LABEL']; ?></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-SERVICES-AREAS-LABEL']; ?></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-PAYMENT-ACCEPT-LABEL']; ?></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    <h5 data-toggle="collapse"
                                        data-target="#jb-expe"><?php echo $Zitiziti['JOB-INTERVIEW-EXPERIENCE-DETAILS-LABEL']; ?></h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    <h5 data-toggle="collapse"
                                        data-target="#jb-edu"><?php echo $Zitiziti['JOB-INTERVIEW-EDUCATIONAL-LABEL']; ?></h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    <h5 data-toggle="collapse"
                                        data-target="#jb-addi"><?php echo $Zitiziti['JOB-INTERVIEW-ADDITIONAL-INFORMATION-LABEL']; ?></h5>
                            ...
                            <div class="form-group col-md-6 serex-time">
                                <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-ID-PROOF-LABEL']; ?></label>
                                <div class="fil-img-uplo">
                                    <span class="dumfil"><?php echo $Zitiziti['UPLOAD_A_FILE'];  ?></span>
                                    <input type="file" name="id_proof" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" class="form-control">
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" name="service_expert_submit" class="blu-upp"><?php echo $Zitiziti['SUBMIT_NOW']; ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
