...
<section class=" login-reg job-form pb-3">
                    ...
                    <form action="service_expert_insert.php" class="service_expert_form" id="service_expert_form"
                        ...
                        <div class="inn">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label
                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-SERVICES-CAN-DO-LABEL']; ?></label>
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button name="service_expert_submit" class="blu-upp"><?php echo $Zitiziti['SUBMIT_NOW']; ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
