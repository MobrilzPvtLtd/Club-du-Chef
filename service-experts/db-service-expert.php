...
?>
   ...
   <div class="ud-main-inn ud-no-rhs">
    <div class="ud-cen">
        ...
        <span class="udb-inst"><?php echo $Zitiziti['SERVICE-EXPERT-ALL-SERVICE-EXPERT-LEADS']; ?></span>
        <?php
        ...
        <div class="ud-cen-s2 px-2">
            ...
            <a href="#" class="db-tit-btn cta-db-exp-avail" data-toggle="modal"
               data-target="#expstatus"><?php echo $Zitiziti['SERVICE-EXPERT-UPDATE-MY-AVAILABILITY']; ?></a>
            <table class="responsive-table bordered" id="myTable">
                <thead>
                <tr>
                    <th><?php echo $Zitiziti['S_NO']; ?></th>
                    <th><?php echo $Zitiziti['SERVICE-EXPERT-LEAD-DETAILS']; ?></th>
                ...
                foreach (getUserExpertEnquiries($_SESSION['user_id']) as $service_expert_enquiry_row) {
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="db-list-edit cta-blu-sml" data-toggle="modal"
                               data-target="#expfrm<?php echo $enquiry_id; ?>"><?php echo $Zitiziti['SERVICE-EXPERT-MANAGE']; ?></a>
                        </td>
                            ...
                            <div class="modal fade" id="expfrm<?php echo $enquiry_id; ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="log-bor">&nbsp;</div>
                                        <span class="udb-inst"><?php echo $Zitiziti['SERVICE-EXPERT-MANAGE-LEAD']; ?></span>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <!-- Modal Header -->
                                        <div class="quote-pop">
                                            <div id="expert_manage_lead_success<?php echo $enquiry_id; ?>" class="log" style="display: none;">
                                                <p><?php echo $Zitiziti['SERVICE-EXPERT-ENQUIRY-STATUS-SUCCESS-MESSAGE']; ?></p>
                                            </div>
                                            ...
                                            <form method="post" name="expert_manage_lead_form" id="expert_manage_lead_form<?php echo $enquiry_id; ?>">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-PREFERRED-DATE']; ?></label>
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-APPROX-ARRIVE-TIME-LABEL']; ?></label>
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-SERVICE-STATUS']; ?></label>
                                                    <select class="chosen-select" name="enquiry_status" id="enquiry_status">
                                                        <option value="500" <?php if ($enquiry_status == 500) {
                                                            echo "selected";
                                                        } ?>><?php echo $Zitiziti['SERVICE-EXPERT-DONE-LABEL']; ?></option>
                                                        <option value="300" <?php if ($enquiry_status == 300) {
                                                            echo "selected";
                                                        } ?>><?php echo $Zitiziti['SERVICE-EXPERT-ON-THE-WAY-LABEL']; ?></option>
                                                        <option value="400" <?php if ($enquiry_status == 400) {
                                                            echo "selected";
                                                        } ?>><?php echo $Zitiziti['SERVICE-EXPERT-PENDING-LABEL']; ?></option>
                                                        <option value="100" <?php if ($enquiry_status == 100) {
                                                            echo "selected";
                                                        } ?>><?php echo $Zitiziti['SERVICE-EXPERT-CANCEL-LABEL']; ?></option>
                                                        <option value="200" <?php if ($enquiry_status == 200) {
                                                            echo "selected";
                                                        } ?>><?php echo $Zitiziti['SERVICE-EXPERT-NEW-LABEL']; ?></option>
                                                    </select>
                                                </div>
        ...
        <div style="padding-bottom: 0!important;" class="pop-ups pop-quo job-form exp-pop-form">
            ...
            <div class="modal fade" id="expstatus">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="log-bor">&nbsp;</div>
                        <span class="udb-inst"><?php echo $Zitiziti['SERVICE-EXPERT-AVAILABILITY']; ?></span>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <!-- Modal Header -->
                        <div class="quote-pop">
                            <div
                                class="ser-exp-wel ser-exp-wel1"><?php echo $Zitiziti['SERVICE-EXPERT-AVAILABILITY-INFO-DIV']; ?></div>
                            <div id="expert_availability_success" class="log" style="display: none;">
                                <p><?php echo $Zitiziti['EXPERT_PROFILE_AVAILABILITY_SUCCESS_MESSAGE']; ?></p>
                            </div>
                            ...
                            <form method="post" name="expert_availability_form" id="expert_availability_form">
                                ...
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-CHOOSE-AVAILABILITY']; ?></label>
                                    <select class="chosen-select" id="expert_availability_status"
                                        ...
                                        <option <?php if ($service_expert_row['expert_availability_status'] == 0) {
                                            ...
                                            value="0"><?php echo $Zitiziti['SERVICE-EXPERT-AVAILABILITY-READY-TO-WORK-LABEL']; ?></option>
                                        <option <?php if ($service_expert_row['expert_availability_status'] == 1) {
                                            echo "selected";
                                        } ?>
                                            value="1"><?php echo $Zitiziti['SERVICE-EXPERT-BUSY-ON-OTHER-CUSTOMER-LABEL']; ?></option>
                                        <option <?php if ($service_expert_row['expert_availability_status'] == 2) {
                                            echo "selected";
                                        } ?> value="2"><?php echo $Zitiziti['SERVICE-EXPERT-END-TODAY-LABEL']; ?></option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-START-TIME-LABEL']; ?></label>
                                ...
                                <div class="form-group">
                                    <label class="tit"><?php echo $Zitiziti['SERVICE-EXPERT-CLOSE-TIME-LABEL']; ?></label>
