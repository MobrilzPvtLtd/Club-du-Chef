...
<section>
    <div class="str hm3-auto-ban">
        <div class="container">
            <div class="row">
                <div class="lhs">
                    <span>Say Hello Doctors</span>
                    <h1>Find your right<br><b id="">Doctors</b> here</h1>
                    <p>We help you to find doctors near you with online inquiry, contact details, photos, map, review and more</p>
                    <a href="all-category">Explore all Doctors</a>
                </div>
                <div class="rhs">
