...
<section>
    <div class="str hm3-auto-ban">
        <div class="container">
            <div class="row">
                <div class="lhs">
                    <span>Restaurants in your pocket</span>
                    <h1>Order your<br><b id="">Food online</b> now</h1>
                    <p>Easy to order your favourite food from your favourite restaurants with more special offers.</p>
                    <a href="all-category">Explore all Foods</a>
                </div>
                <div class="rhs">
