            ...
            <div class="news-menu">
                <ul>
                    ...
                    foreach (getAllNewsCategoriesPos() as $news_category_row) {
                        ?>
                        <li><a href="<?php echo $ALL_NEWS_URL . urlModifier($news_category_row['category_slug']); ?>" class="<?php if($category_search_name == $news_category_row['category_name']){ echo 'act'; } ?>"><?php echo $news_category_row['category_name']; ?></a></li>
                        <?php
                    }
                    ?>
                </ul>
                ...
                if (mysqli_num_rows($newsrs) > 0) {
                    ...
                    while ($newsrow = mysqli_fetch_array($newsrs)) {
                        ...
                        <div class="news-home-box news-home-box1">
                            <div class="im">
                                <img loading="lazy" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="b-lazy" data-src="<?php echo $slash; ?>/news/images/news/<?php echo $newsrow['news_image']; ?>"
                                     alt="">
                            </div>
                            <div class="txt">
                ...
                foreach ($latest_news_query as $latest_news_row) {
                    ...
                    <div class="col-md-4">
                        <div class="news-home-box">
                            <div class="im">
                                <img loading="lazy" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="b-lazy" data-src="<?php echo $slash; ?>/news/images/news/<?php echo $latest_news_row['news_image']; ?>"
                                    alt="">
                            </div>
                            <div class="txt">
