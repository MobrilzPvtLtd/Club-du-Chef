 ...
 foreach ($days as $day) {
     ...
     if ($is_available == 1) {
         ...
         if (mysqli_num_rows($result) > 0) {
             ...
             $update_queries[] = "UPDATE " . TBL . "booking_availability SET start_time = '$start_time', end_time = '$end_time', is_available = 1, created_at = '$curDate' WHERE booking_type_id = '$booking_type_id' AND day = '$day' AND booking_type = '$booking_type'";
         } else {
             // If the day does not exist, insert a new record
             $insert_queries[] = "INSERT INTO " . TBL . "booking_availability (booking_type_id, day, booking_type,start_time, end_time, is_available, created_at) VALUES ('$booking_type_id', '$day', '$booking_type', '$start_time', '$end_time', 1, '$curDate')";
         }
     } else {
