...
?>
   ...
   <div class="ud-main-inn ud-no-rhs">
    <div class="ud-cen">
        ...
        <span class="udb-inst"><?php echo $Zitiziti['FOLLOWINGS']; ?></span>
        <?php include('config/user_activation_checker.php'); ?>
        <div class="ud-cen-s2">
            <h2><?php echo $Zitiziti['DB-FOLLOWINGS-FOLLOWING-USERS']; ?></h2>
            <?php include "page_level_message.php"; ?>
            <a href="db-all-users" class="db-tit-btn"><?php echo $Zitiziti['DB-FOLLOWINGS-VIEW-ALL-USERS']; ?></a>
                        ...
                        <li>
                            <div class="pro-fol-gr">
                                ...
                                <div class="pro-pg-msg">
                                    <span><i class="material-icons">message</i> <?php echo $Zitiziti['MESSAGES']; ?></span>
                                <span class="userfollow follow-content<?php echo $all_user_id ?>"
                                      data-item="<?php echo $all_user_id; ?>"
                                      data-num="<?php echo $_SESSION['user_id']; ?>"><?php echo $Zitiziti['UN_FOLLOW']; ?></span>
                                </div>
                            </div>
                        </li>
                        <?php
