                ...
                <div class="login-main add-list posr">
                    ...
                    <div class="log log-1">
                        <div class="login">
                            ...
                            $row = getTopCategory($category_id);

                            ?>
                            <form name="category_form" id="category_form" method="post" action="update_home_category.php" enctype="multipart/form-data">
                                ...
                                <ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" name="home_category_submit" class="btn btn-primary">Update</button>
                                        </div>
                                        <div class="col-md-12">
