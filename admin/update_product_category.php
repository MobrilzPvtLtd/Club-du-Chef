...
//************ Category Name Already Exist Check Ends ***************
        ...
        function checkProductttCategorySlug($link, $category_id, $counter = 1)
        {
            global $conn;
            $newLink = $link;
            do {
        ...
        $sql = mysqli_query($conn, "UPDATE  " . TBL . "product_categories SET category_name='" . $category_name . "',city_slug='" . $city_slug_json . "', category_status='" . $category_status . "'
