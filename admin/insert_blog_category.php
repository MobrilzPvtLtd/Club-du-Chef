...
// *********** if Count of category name is zero means redirect starts ********
    ...
    if ($cnt == 0) {
        header('Location: admin-add-new-blog-category.php');
        exit;
    }
...
//        function checkBlogCategorySlug($link, $counter = 1)
//        {
//            global $conn;
//            $newLink = $link;
//            do {
...
//        $category_slug = checkBlogCategorySlug($category_name1);
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . TBL . "blog_categories (category_name,city_slug,category_status,category_image,category_filter_pos_id,category_slug,category_cdt) VALUES ('$category_name','$city_slug_json','$category_status','$category_image','$category_filter_pos_id', '$category_slug', '$curDate')");
    ...
    if ($upqry) {
        ...
        $_SESSION['status_msg'] = "Blog Category(s) has been Added Successfully!!!";
