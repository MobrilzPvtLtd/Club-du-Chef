...
//****************************    client email ends    *************************
            ...
            if ($blog_type_id == 1) {
                ...
                $_SESSION['status_msg'] = "New Blog has been created Successfully!!!";

                header('Location: admin-all-blogs.php');

            } else {

                header("Location: paypal_pay.php?map_id=$listlastID&type_id=$blog_type_id");
            ...
            header('Location: admin-add-new-blogs.php');
        }
