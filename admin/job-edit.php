                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    <?php
                                        ...
                                        $check_query = "SELECT * FROM " . TBL . "booking_availability WHERE job_id = '{$job_a_row['job_id']}' AND is_available = 1";
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="chbox">
                                                                <input type="checkbox" name="booking" id="booking" <?php echo ($job_a_row['is_booking'] == 1 || $job_a_row['booking_url'] != '') ? 'checked' : ''; ?>>
                                                                <label for="booking">Booking System</label>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-12" id="booking-details" style="display: <?php echo ($job_a_row['is_booking'] == 1 || $job_a_row['booking_url'] != '') ? 'block' : 'none'; ?>;">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="1" name="is_booking" id="is_booking" <?php echo $job_a_row['is_booking'] == 1 ? 'checked' : ''; ?>>
                                                            <label class="form-check-label" for="is_booking">Use inbuilt booking system</label>
                                                        </div>

                                                        <!-- Days fieilds  -->
                                                        <div class="form-group mt-2" id="booking_days" style="display: <?php echo ($job_a_row['is_booking'] == 1 || $job_a_row['booking_url'] != '') ? 'block' : 'none'; ?>;">
                                                            ...
                                                            <div class="chbox">
                                                                ...
                                                                <div class="row <?php echo strtolower($day); ?>_time" style="display: <?php echo $is_checked ? 'block' : 'none'; ?>;">
                                                                    <div class="form-group col-md-4 serex-date">
                                                                        <input type="time" class="form-control mb-3" name="start_time_<?php echo strtolower($day); ?>" value="<?php echo $start_time; ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-4 serex-date">
                                                                        <input type="time" class="form-control mb-3" name="end_time_<?php echo strtolower($day); ?>" value="<?php echo $end_time; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="0" name="is_booking" id="is_booking_url" <?php echo $job_a_row['is_booking'] == 0 ? 'checked' : ''; ?>>
