                    ...
                    <div class="row">
                        <div class="plac-panl">
                            ...
                            <?php
                                ...
                                $check_query = "SELECT * FROM " . TBL . "booking_availability WHERE place_id = '{$place_row['place_id']}' AND is_available = 1";
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="chbox">
                                                            <input type="checkbox" name="booking" id="booking" style="height: 0;" <?php echo ($place_row['is_booking'] == 1 || $place_row['booking_url'] != '') ? 'checked' : ''; ?>>
                                                            <label for="booking">Booking System</label>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="col-md-12" id="booking-details" style="display: <?php echo ($place_row['is_booking'] == 1 || $place_row['booking_url'] != '') ? 'block' : 'none'; ?>;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="1" name="is_booking" id="is_booking" <?php echo $place_row['is_booking'] == 1 ? 'checked' : ''; ?> style="height: 30px;">
                                                        <label class="form-check-label" style="margin-top: 10px;" for="is_booking">Use inbuilt booking system</label>
                                                    </div>

                                                    <!-- Days fieilds  -->
                                                    <div class="form-group mt-2" id="booking_days" style="display: <?php echo ($place_row['is_booking'] == 1) ? 'block' : 'none'; ?>;">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0" name="is_booking" id="is_booking_url" <?php echo $place_row['is_booking'] == 0 ? 'checked' : ''; ?> style="height: 30px;">
                                                        <label class="form-check-label" style="margin-top: 10px;" for="is_booking_url">Use your own booking system</label>
                                                    </div>

                                                    <div class="form-group mt-2" id="booking_url_group" style="display: <?php echo ($place_row['booking_url']) ? 'block' : 'none'; ?>;">
                                                        <input type="text" name="booking_url" id="booking_url" class="form-control" value="<?php echo $place_row['booking_url']; ?>" placeholder="Enter your booking system url...">
                                                    </div>
                                                </div>
                                                <!-- BOOKING SYSTEM END -->
