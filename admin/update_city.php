...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['city_submit'])) {
        ...
        $sql = mysqli_query($conn, "UPDATE  " . TBL . "cities SET city_name='" . $city_name . "', city_slug='" . $city_slug . "',city_logo_1='" . $city_logo_1 . "',city_logo_2='" . $city_logo_2 . "',
