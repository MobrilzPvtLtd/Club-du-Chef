        ...
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <div class="ud-cen-s2">
                    ...
                    <div style="display: none" class="static-success-message log-suc"><p>Listing(s) has been Permanently Deleted!!! Please wait for automatic page refresh!! </p></div>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getListingReview($reviewlisting_id) as $Star_rateRow) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo $LISTING_URL.urlModifier($listrow['listing_slug']); ?>" class="db-list-edit" target="_blank">Preview</a>
                                </td>
