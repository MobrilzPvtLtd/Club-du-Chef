                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">New Event Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Add New Event Category</h4>
                                    ...
                                    <form name="category_form" id="category_form" method="post" action="insert_event_category.php" class="cre-dup-form cre-dup-form-show" enctype="multipart/form-data">
                                        <ul>
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-12">
