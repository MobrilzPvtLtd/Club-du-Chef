...
// Blog Edit Form validation ends<!--All Listing page Enquiry Form Ajax Call And Validation starts-->
...
// User Ad Request Form validation ends<!--Home page slide Enquiry Form Ajax Call And Validation starts-->
...
<!--Home page slide Enquiry Form Ajax Call And Validation ends--><!--Home page Enquiry Form Ajax Call And Validation starts-->
...
<!--Home page Enquiry Form Ajax Call And Validation ends-->// product Form validation starts
$(document).ready(function () {
...
$('#popup_claim_form').click(function() {
    // evt.preventDefault();    $("#popup_claim_form").validate({
        rules: {
            enquiry_name: {required: true},
...
<!--Pop Up Claim Form Detail Page Ajax Call And Validation ends--><!--Pop Up Enquiry Form Detail Page Ajax Call And Validation starts-->
...
//Promotion Listing Form validation ends// Buy Points Form validation starts
$(document).ready(function () {
